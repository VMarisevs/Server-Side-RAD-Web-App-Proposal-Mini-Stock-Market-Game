...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10001, N'Google', N'g', 'google.png',  20, 1001, 1, N'Google 
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10002, N'Microsoft Corporation', N'MS', 'microsoft.png',  20, 1001, 2, N'Microsoft Corporation
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10003, N'Amazon.com, Inc.', N'AMZN', 'amazon.png',  20, 1001, 3, N'Amazon.com, Inc.
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10004, N'Royal Dutch Shell', N'Shell',  'shell.png', 20, 1002, 4, N'Royal Dutch Shell
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10005, N'Mobil', N'Mobil', 'mobil.png', 20, 1002, 5, N'', N'Mobil, previously known as the Socony-Vacuum Oil Company, was a major Anglo-American oil company which merged with Exxon in 1999 to form ExxonMobil.')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10006, N'Bayerische Motoren Werke AG', N'BMW', 'bmw.png', 20, 1003, 10, N'', N'Bayerische Motoren Werke AG, commonly known as BMW or BMW AG, is a German automobile, motorcycle and engine manufacturing company founded in 1916. BMW is headquartered in Munich, Bavaria')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10007, N'Audi AG', N'Audi', 'audi.png', 20, 1003, 4, N'', N'Audi AG is a German automobile manufacturer that designs, engineers, produces, markets and distributes luxury automobiles. Audi oversees worldwide operations from its headquarters in Ingolstadt, Bavaria, Germany.')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10008, N'Volkswagen Group', N'VW', 'vw.png', 20, 1003, 3, N'', N'Volkswagen Group and its subsidiaries, is a German multinational automotive manufacturing company headquartered in Wolfsburg, Lower Saxony, Germany.')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10009, N'Mercedes-Benz', N'MB', 'mercedes.png', 20, 1003, 2, N'', N'Mercedes-Benz is a German automobile manufacturer, a multinational division of the German manufacturer Daimler AG. The brand is used for luxury automobiles, buses, coaches, and trucks.')
...
--SET IDENTITY_INSERT [dbo].[UserShares] OFF
