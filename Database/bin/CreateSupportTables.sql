...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10001, N'Google', N'g', NULL,  20, 1001, 10, N'Google 
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10002, N'Microsoft Corporation', N'MS', NULL,  20, 1001, 8, N'Microsoft Corporation
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10003, N'Amazon.com, Inc.', N'AMZN', NULL,  20, 1001, 14, N'Amazon.com, Inc.
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10004, N'Royal Dutch Shell', N'Shell',  NULL, 20, 1002, 20, N'Royal Dutch Shell
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10005, N'Mobil', N'Mobil', NULL, 20, 1002, 22, N'', N'Mobil, previously known as the Socony-Vacuum Oil Company, was a major Anglo-American oil company which merged with Exxon in 1999 to form ExxonMobil.')
...
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10007, N'Audi AG', N'Audi', NULL, 20, 1003, 9, N'', N'Audi AG is a German automobile manufacturer that designs, engineers, produces, markets and distributes luxury automobiles. Audi oversees worldwide operations from its headquarters in Ingolstadt, Bavaria, Germany.')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10008, N'Volkswagen Group', N'VW', NULL, 20, 1003, 10, N'', N'Volkswagen Group and its subsidiaries, is a German multinational automotive manufacturing company headquartered in Wolfsburg, Lower Saxony, Germany.')
INSERT INTO [dbo].[Companies] ([Id], [Name], [Abbreviation], [logo], [shareAmount], [categoryId], [volatility], [shortDescription], [longDescription]) VALUES (10009, N'Mercedes-Benz', N'MB', NULL, 20, 1003, 7, N'', N'Mercedes-Benz is a German automobile manufacturer, a multinational division of the German manufacturer Daimler AG. The brand is used for luxury automobiles, buses, coaches, and trucks.')
